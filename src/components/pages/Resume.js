        ...
        <div id="resume-content">
          <div id="resume-text">
            ...
            <p>
              ...
              applications in an agile and ever-changing environment. Create
              the documentation, Samples, required unit test, and integration
              tests.
            </p>
            <h4> Giesecke+Devrient Mobile Security</h4>
            <p>
              Design and implement APIs to retrieve the written script by
              users and apply its logic to give the user more control over its
              data validation and customization. implement the functionality
              to splitting the data to process parallel and merge it, based on
              its category Design and implement a user-friendly interface to
              have more control over the application in HSM. Design and
              implement the table structures and relevant stored procedures to
              convert the incoming data from APIs or flat files fed by the
              clients. Processing the Data on HSM servers by writing down and
              Implementing the required functionality. Controlling the data
              flow of the retrieved and processed data to the application to use
              by other teams. Maintaining, debugging, and writing unit tests,
            ...
            <h4>10Count</h4>
            <p>
              Design and implement a chat system with react native for
              trainers to connect and share information and reduce the
              time-consuming and complexity of using the different sharing
              systems. Implement required APIs, HOCs, and data structure from
              scratch using MERN stack, socket.io, react hooks, and lazy
              loading. Design and implement a share location system for the
              clients to find the location during the pandemic. integrate Maps
              Geocoding, Calendar, WeatherAPI, COVID-19 APIs, etc. to make
              Intelligent UI/UX. Design and implement the APIs to connect to
              the existing sensors to collect and store the data. Transfer the
              data sent by the Microsoft WCF to the newly designed front-end use
              react. implement third-party APIs and components using React and
              Redux to Design reports and charts.
            </p>
            <h4>Education</h4>
            <ul>
              <li>
